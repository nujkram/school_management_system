...
from .managers import YearLevelManager as manager
...
class YearLevel(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        related_name='year_levels_created_by_user'
    )
    last_updated_by = models.ForeignKey(
        ...
        db_index=False,
        on_delete=models.SET_NULL,
        related_name='year_levels_updated_by_user'
    )
...
# === Signals ===
################################################################################
@receiver(post_save, sender=YearLevel)
def scaffold_post_save(sender, instance=None, created=False, **kwargs):
    pass


@receiver(pre_save, sender=YearLevel)
